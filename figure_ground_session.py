...
from trial_figure_ground import FGSegTrial
import random
...
class FigureGroundSession(PylinkEyetrackerSession):
    ...
    def create_stimuli(self):
        ...
        self.homogen_grey = visual.Rect(self.win, units='deg', colorSpace='rgb255', size=self.stim_size, lineColor=[162,162,162], fillColor=[162,162,162])
    ...
    def draw_stimulus(self, phase):
        ...
        """
        while self.current_trial.pause_switch:
            time.sleep(1)
